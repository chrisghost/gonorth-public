...
var len__5769__auto___13046 = arguments.length;
var i__5770__auto___13047 = (0);
while(true){
if((i__5770__auto___13047 < len__5769__auto___13046)){
args__5775__auto__.push((arguments[i__5770__auto___13047]));

var G__13048 = (i__5770__auto___13047 + (1));
i__5770__auto___13047 = G__13048;
continue;
} else {
}
break;
...
/** @this {Function} */
(devtools.formatters.printing.build_markup.cljs$lang$applyTo = (function (seq12834){
...
return self__5754__auto__.cljs$core$IFn$_invoke$arity$variadic(G__12835,G__12836,seq12834__$2);
}));
...
if(cljs.core.truth_(devtools.formatters.helpers.should_render_QMARK_(new cljs.core.Keyword(null,"render-metas","render-metas",1141294116),value,(function (p1__12958_SHARP_){
return (!((cljs.core.meta(p1__12958_SHARP_) == null)));
})))){
...
var markup_db = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__12976__$1,new cljs.core.Keyword(null,"markup-db","markup-db",812838734));
...
}catch (e12978){var _e__11868__auto__ = e12978;
return false;
}})();
if(cljs.core.truth_(or__5045__auto__)){
return or__5045__auto__;
...
}catch (e12982){var _e__11868__auto__ = e12982;
return false;
}}
})())){
...
var _STAR_current_state_STAR__orig_val__12993 = devtools.formatters.state._STAR_current_state_STAR_;
var _STAR_current_state_STAR__temp_val__12994 = devtools.formatters.state.get_current_state();
(devtools.formatters.state._STAR_current_state_STAR_ = _STAR_current_state_STAR__temp_val__12994);
...
var map__12997 = opts;
var map__12997__$1 = cljs.core.__destructure_map(map__12997);
var markup_db = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__12997__$1,new cljs.core.Keyword(null,"markup-db","markup-db",812838734));
...
}finally {(devtools.formatters.state._STAR_current_state_STAR_ = _STAR_current_state_STAR__orig_val__12993);
}});
...
var temp__5802__auto___13096 = devtools.formatters.state.get_managed_print_level();
if(cljs.core.truth_(temp__5802__auto___13096)){
var managed_print_level_13097 = temp__5802__auto___13096;
var _STAR_print_level_STAR__orig_val__13006_13099 = cljs.core._STAR_print_level_STAR_;
var _STAR_print_level_STAR__temp_val__13008_13100 = managed_print_level_13097;
(cljs.core._STAR_print_level_STAR_ = _STAR_print_level_STAR__temp_val__13008_13100);

try{devtools.formatters.state.update_current_state_BANG_((function (p1__12999_SHARP_){
return devtools.formatters.state.set_managed_print_level(p1__12999_SHARP_,null);
}));

job_fn();
}finally {(cljs.core._STAR_print_level_STAR_ = _STAR_print_level_STAR__orig_val__13006_13099);
}} else {
job_fn();
}
