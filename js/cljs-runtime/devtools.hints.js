...
var temp__5802__auto___12942 = devtools.hints.get_processed_errors_BANG_();
if(cljs.core.truth_(temp__5802__auto___12942)){
var seen_errors_12943 = temp__5802__auto___12942;
if(cljs.core.truth_(seen_errors_12943.has(self))){
} else {
seen_errors_12943.add(self);

var temp__5804__auto___12944 = devtools.hints.error_object_sense(self);
if(cljs.core.truth_(temp__5804__auto___12944)){
var sense_12945 = temp__5804__auto___12944;
(self.message = [cljs.core.str.cljs$core$IFn$_invoke$arity$1(self.message),", a sanity hint:\n",cljs.core.str.cljs$core$IFn$_invoke$arity$1(sense_12945)].join(''));
} else {
}
}
} else {
