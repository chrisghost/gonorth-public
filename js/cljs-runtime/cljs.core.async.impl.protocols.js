...
var cljs$core$async$impl$protocols$ReadPort$take_BANG_$dyn_13171 = (function (port,fn1_handler){
...
return cljs$core$async$impl$protocols$ReadPort$take_BANG_$dyn_13171(port,fn1_handler);
}
});
...
var cljs$core$async$impl$protocols$WritePort$put_BANG_$dyn_13181 = (function (port,val,fn1_handler){
var x__5393__auto__ = (((port == null))?null:port);
...
return cljs$core$async$impl$protocols$WritePort$put_BANG_$dyn_13181(port,val,fn1_handler);
}
});
...
var cljs$core$async$impl$protocols$Channel$close_BANG_$dyn_13186 = (function (chan){
...
return cljs$core$async$impl$protocols$Channel$close_BANG_$dyn_13186(chan);
}
});

var cljs$core$async$impl$protocols$Channel$closed_QMARK_$dyn_13197 = (function (chan){
var x__5393__auto__ = (((chan == null))?null:chan);
...
return cljs$core$async$impl$protocols$Channel$closed_QMARK_$dyn_13197(chan);
}
});
...
var cljs$core$async$impl$protocols$Handler$active_QMARK_$dyn_13209 = (function (h){
...
return cljs$core$async$impl$protocols$Handler$active_QMARK_$dyn_13209(h);
}
});

var cljs$core$async$impl$protocols$Handler$blockable_QMARK_$dyn_13213 = (function (h){
var x__5393__auto__ = (((h == null))?null:h);
...
return cljs$core$async$impl$protocols$Handler$blockable_QMARK_$dyn_13213(h);
}
});

var cljs$core$async$impl$protocols$Handler$commit$dyn_13217 = (function (h){
var x__5393__auto__ = (((h == null))?null:h);
...
return cljs$core$async$impl$protocols$Handler$commit$dyn_13217(h);
}
});
...
var cljs$core$async$impl$protocols$Buffer$full_QMARK_$dyn_13222 = (function (b){
...
return cljs$core$async$impl$protocols$Buffer$full_QMARK_$dyn_13222(b);
}
});

var cljs$core$async$impl$protocols$Buffer$remove_BANG_$dyn_13228 = (function (b){
var x__5393__auto__ = (((b == null))?null:b);
...
return cljs$core$async$impl$protocols$Buffer$remove_BANG_$dyn_13228(b);
}
});

var cljs$core$async$impl$protocols$Buffer$add_BANG__STAR_$dyn_13237 = (function (b,itm){
var x__5393__auto__ = (((b == null))?null:b);
...
return cljs$core$async$impl$protocols$Buffer$add_BANG__STAR_$dyn_13237(b,itm);
}
});

var cljs$core$async$impl$protocols$Buffer$close_buf_BANG_$dyn_13243 = (function (b){
var x__5393__auto__ = (((b == null))?null:b);
...
return cljs$core$async$impl$protocols$Buffer$close_buf_BANG_$dyn_13243(b);
}
});
