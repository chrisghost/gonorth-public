...
var len__5769__auto___16399 = arguments.length;
var i__5770__auto___16401 = (0);
while(true){
if((i__5770__auto___16401 < len__5769__auto___16399)){
args__5775__auto__.push((arguments[i__5770__auto___16401]));

var G__16402 = (i__5770__auto___16401 + (1));
i__5770__auto___16401 = G__16402;
continue;
} else {
}
break;
...
var _STAR_print_newline_STAR__orig_val__16220_16403 = cljs.core._STAR_print_newline_STAR_;
var _STAR_print_fn_STAR__orig_val__16221_16404 = cljs.core._STAR_print_fn_STAR_;
var _STAR_print_newline_STAR__temp_val__16222_16405 = true;
var _STAR_print_fn_STAR__temp_val__16223_16406 = (function (x__5691__auto__){
return sb__5690__auto__.append(x__5691__auto__);
});
(cljs.core._STAR_print_newline_STAR_ = _STAR_print_newline_STAR__temp_val__16222_16405);

(cljs.core._STAR_print_fn_STAR_ = _STAR_print_fn_STAR__temp_val__16223_16406);

try{var _STAR_print_level_STAR__orig_val__16230_16407 = cljs.core._STAR_print_level_STAR_;
var _STAR_print_level_STAR__temp_val__16231_16408 = (300);
(cljs.core._STAR_print_level_STAR_ = _STAR_print_level_STAR__temp_val__16231_16408);

try{cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.pprint.pprint,args);
}finally {(cljs.core._STAR_print_level_STAR_ = _STAR_print_level_STAR__orig_val__16230_16407);
}}finally {(cljs.core._STAR_print_fn_STAR_ = _STAR_print_fn_STAR__orig_val__16221_16404);

(cljs.core._STAR_print_newline_STAR_ = _STAR_print_newline_STAR__orig_val__16220_16403);
}
...
/** @this {Function} */
(devtools.util.pprint_str.cljs$lang$applyTo = (function (seq16217){
var self__5755__auto__ = this;
return self__5755__auto__.cljs$core$IFn$_invoke$arity$variadic(cljs.core.seq(seq16217));
}));
...
var new_formatters = current_formatters.filter((function (p1__16275_SHARP_){
return (!(cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(detector,p1__16275_SHARP_)));
}));
...
var G__16281_16422 = f;
var target__11862__auto___16423 = G__16281_16422;
if(cljs.core.truth_(target__11862__auto___16423)){
} else {
throw (new Error(["Assert failed: ",["unable to locate object path ",null," in ",cljs.core.str.cljs$core$IFn$_invoke$arity$1(G__16281_16422)].join(''),"\n","target__11862__auto__"].join('')));
}

(target__11862__auto___16423["toString"] = (function (){
...
var G__16296_16424 = "%c%s";
var G__16297_16425 = "color:transparent";
var G__16298_16426 = devtools.util.make_detection_printer();
(f.cljs$core$IFn$_invoke$arity$3 ? f.cljs$core$IFn$_invoke$arity$3(G__16296_16424,G__16297_16425,G__16298_16426) : f.call(null,G__16296_16424,G__16297_16425,G__16298_16426));
...
var args__5775__auto__ = [];
var len__5769__auto___16430 = arguments.length;
var i__5770__auto___16431 = (0);
while(true){
if((i__5770__auto___16431 < len__5769__auto___16430)){
args__5775__auto__.push((arguments[i__5770__auto___16431]));

var G__16432 = (i__5770__auto___16431 + (1));
i__5770__auto___16431 = G__16432;
continue;
} else {
}
break;
...
var vec__16337 = devtools.util.feature_list_display(installed_features,feature_groups);
var fmt_str = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__16337,(0),null);
var fmt_params = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__16337,(1),null);
return devtools.util.wrap_with_custom_formatter_detection_BANG_((function() { 
var G__16436__delegate = function (add_fmt,add_args){
...
var G__16436 = function (add_fmt,var_args){
var add_args = null;
if (arguments.length > 1) {
var G__16440__i = 0, G__16440__a = new Array(arguments.length -  1);
while (G__16440__i < G__16440__a.length) {G__16440__a[G__16440__i] = arguments[G__16440__i + 1]; ++G__16440__i;}
  add_args = new cljs.core.IndexedSeq(G__16440__a,0,null);
} 
return G__16436__delegate.call(this,add_fmt,add_args);};
G__16436.cljs$lang$maxFixedArity = 1;
G__16436.cljs$lang$applyTo = (function (arglist__16441){
var add_fmt = cljs.core.first(arglist__16441);
var add_args = cljs.core.rest(arglist__16441);
return G__16436__delegate(add_fmt,add_args);
});
...
/** @this {Function} */
(devtools.util.display_banner_BANG_.cljs$lang$applyTo = (function (seq16322){
var G__16323 = cljs.core.first(seq16322);
var seq16322__$1 = cljs.core.next(seq16322);
var G__16325 = cljs.core.first(seq16322__$1);
var seq16322__$2 = cljs.core.next(seq16322__$1);
var G__16326 = cljs.core.first(seq16322__$2);
var seq16322__$3 = cljs.core.next(seq16322__$2);
var self__5754__auto__ = this;
return self__5754__auto__.cljs$core$IFn$_invoke$arity$variadic(G__16323,G__16325,G__16326,seq16322__$3);
}));
...
var seq__16355 = cljs.core.seq(features);
var chunk__16356 = null;
var count__16357 = (0);
var i__16358 = (0);
while(true){
if((i__16358 < count__16357)){
var feature = chunk__16356.cljs$core$IIndexed$_nth$arity$2(null,i__16358);
...
var G__16447 = seq__16355;
var G__16448 = chunk__16356;
var G__16449 = count__16357;
var G__16450 = (i__16358 + (1));
seq__16355 = G__16447;
chunk__16356 = G__16448;
count__16357 = G__16449;
i__16358 = G__16450;
continue;
} else {
...
var G__16453 = cljs.core.chunk_rest(seq__16355__$1);
var G__16454 = c__5568__auto__;
var G__16455 = cljs.core.count(c__5568__auto__);
var G__16456 = (0);
seq__16355 = G__16453;
chunk__16356 = G__16454;
count__16357 = G__16455;
i__16358 = G__16456;
continue;
} else {
var feature = cljs.core.first(seq__16355__$1);
if(cljs.core.not(cljs.core.some(cljs.core.PersistentHashSet.createAsIfByAssoc([feature]),known_features))){
devtools.context.get_console.call(null).warn(devtools.util.unknown_feature_msg.call(null,feature,known_features,lib_info));
} else {
}
...
var G__16461 = cljs.core.next(seq__16355__$1);
var G__16462 = null;
var G__16463 = (0);
var G__16464 = (0);
seq__16355 = G__16461;
chunk__16356 = G__16462;
count__16357 = G__16463;
i__16358 = G__16464;
continue;
}
} else {
...
if(cljs.core.truth_(temp__5802__auto__)){
var o16383 = temp__5802__auto__;
return (o16383["version"]);
} else {
return null;
}
})() == null);
