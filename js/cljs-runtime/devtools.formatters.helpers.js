...
var G__12822 = devtools.prefs.pref(v);
v = G__12822;
continue;
} else {
return v;
...
}catch (e12737){var _e__11868__auto__ = e12737;
return false;
}})();
...
}catch (e12740){var _e__11868__auto__ = e12740;
return false;
}})();
...
}catch (e12743){var _e__11868__auto__ = e12743;
return false;
}}
}
});
...
var vec__12765 = devtools.munging.parse_constructor_info(constructor_fn);
var ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__12765,(0),null);
var name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__12765,(1),null);
...
return cljs.core.some((function (p1__12783_SHARP_){
return cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(devtools.formatters.helpers.pref(new cljs.core.Keyword(null,"more-marker","more-marker",-14717935)),p1__12783_SHARP_);
}),template);
});
