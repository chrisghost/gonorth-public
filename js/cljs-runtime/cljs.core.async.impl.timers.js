...
var i_16295 = (self__.level + (1));
while(true){
if((i_16295 <= (new_level + (1)))){
(update[i_16295] = self__.header);

var G__16299 = (i_16295 + (1));
i_16295 = G__16299;
continue;
} else {
}
...
while(true){
if((i <= self__.level)){
var links_16300 = (update[i]).forward;
if((i < x__$2.forward.length)){
(x__$2.forward[i] = (links_16300[i]));
} else {
x__$2.forward.push((((i < links_16300.length))?(links_16300[i]):null));
}

if((i < links_16300.length)){
(links_16300[i] = x__$2);
} else {
links_16300.push(x__$2);
}
...
var i_16304 = (0);
while(true){
if((i_16304 <= self__.level)){
var links_16305 = (update[i_16304]).forward;
if((x__$1 === (((i_16304 < links_16305.length))?(links_16305[i_16304]):null))){
(links_16305[i_16304] = (x__$1.forward[i_16304]));

var G__16306 = (i_16304 + (1));
i_16304 = G__16306;
continue;
} else {
var G__16307 = (i_16304 + (1));
i_16304 = G__16307;
continue;
}
} else {
...
var G__16309 = nx;
var G__16310 = (level__$1 - (1));
x = G__16309;
level__$1 = G__16310;
continue;
} else {
var G__16311 = x;
var G__16312 = (level__$1 - (1));
x = G__16311;
level__$1 = G__16312;
continue;
}
...
if(cljs.core.truth_(nx)){
var G__16317 = nx;
var G__16318 = (level__$1 - (1));
x = G__16317;
level__$1 = G__16318;
continue;
} else {
var G__16319 = x;
var G__16320 = (level__$1 - (1));
x = G__16319;
level__$1 = G__16320;
continue;
}
