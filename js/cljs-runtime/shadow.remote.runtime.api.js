...
var shadow$remote$runtime$api$IRuntime$relay_msg$dyn_16800 = (function (runtime,msg){
...
return shadow$remote$runtime$api$IRuntime$relay_msg$dyn_16800(runtime,msg);
}
});

var shadow$remote$runtime$api$IRuntime$add_extension$dyn_16813 = (function (runtime,key,spec){
var x__5393__auto__ = (((runtime == null))?null:runtime);
...
return shadow$remote$runtime$api$IRuntime$add_extension$dyn_16813(runtime,key,spec);
}
});

var shadow$remote$runtime$api$IRuntime$del_extension$dyn_16818 = (function (runtime,key){
var x__5393__auto__ = (((runtime == null))?null:runtime);
...
return shadow$remote$runtime$api$IRuntime$del_extension$dyn_16818(runtime,key);
}
});
...
var shadow$remote$runtime$api$Inspectable$describe$dyn_16857 = (function (thing,opts){
...
return shadow$remote$runtime$api$Inspectable$describe$dyn_16857(thing,opts);
}
}
});
...
var shadow$remote$runtime$api$IEvalCLJS$_cljs_eval$dyn_16888 = (function (runtime,input,callback){
var x__5393__auto__ = (((runtime == null))?null:runtime);
...
return shadow$remote$runtime$api$IEvalCLJS$_cljs_eval$dyn_16888(runtime,input,callback);
}
});
...
var shadow$remote$runtime$api$IEvalJS$_js_eval$dyn_16899 = (function (runtime,code){
var x__5393__auto__ = (((runtime == null))?null:runtime);
...
return shadow$remote$runtime$api$IEvalJS$_js_eval$dyn_16899(runtime,code);
}
});


shadow.remote.runtime.api.cljs_eval = (function shadow$remote$runtime$api$cljs_eval(runtime,p__16780,callback){
var map__16782 = p__16780;
var map__16782__$1 = cljs.core.__destructure_map(map__16782);
var input = map__16782__$1;
var code = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__16782__$1,new cljs.core.Keyword(null,"code","code",1586293142));
var ns = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__16782__$1,new cljs.core.Keyword(null,"ns","ns",441598760));
